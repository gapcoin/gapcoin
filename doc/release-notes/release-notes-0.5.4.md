Gapcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/gapcoin/files/Gapcoin/gapcoin-0.5.4/
...
http://gitorious.org/gapcoin/gapcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Gapcoin-Qt notifications under Growl 1.3.
Increase required age of Gapcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxGapcoin properly when installing Gapcoin-Qt over it. (Windows)
