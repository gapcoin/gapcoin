Gapcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/gapcoin/files/Gapcoin/gapcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Gapcoin
...
New/changed settings (command-line or gapcoin.conf file)
--------------------------------------------------------
