Gapcoin Core version 0.9.2 is now available from:

  https://gapcoin.org/bin/0.9.2/
...
installer (on Windows) or just copy over /Applications/Gapcoin-Qt (on Mac) or
gapcoind/gapcoin-qt (on Linux).
...
- Lower paytxfee warning threshold from 0.25 GAP to 0.01 GAP
...
- Fix "Start gapcoin on system login"
