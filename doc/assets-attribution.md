The following is a list of assets used in the gapcoin source and their proper attribution.
...
* License: MIT
* Site: [https://gapcointalk.org/index.php?topic=15276.0](https://gapcointalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original gapcoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/gapcoin.icns, src/qt/res/src/gapcoin.svg,
	src/qt/res/src/gapcoin.ico, src/qt/res/src/gapcoin.png,
	src/qt/res/src/gapcoin_testnet.png, docs/gapcoin_logo_doxygen.png,
