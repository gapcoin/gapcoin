// Copyright (c) 2012-2013 The Gapcoin Core developers
...
{
    BOOST_CHECK(TestSplitHost("www.gapcoin.org", "www.gapcoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.gapcoin.org]", "www.gapcoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.gapcoin.org:80", "www.gapcoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.gapcoin.org]:80", "www.gapcoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:31469", "127.0.0.1", 31469));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:31469", "127.0.0.1", 31469));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:31469", "::ffff:127.0.0.1", 31469));
    BOOST_CHECK(TestSplitHost("[::]:31469", "::", 31469));
    BOOST_CHECK(TestSplitHost("::31469", "::31469", -1));
    BOOST_CHECK(TestSplitHost(":31469", "", 31469));
    BOOST_CHECK(TestSplitHost("[]:31469", "", 31469));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:31469", "127.0.0.1:31469"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:31469", "[::]:31469"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
