    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Gapcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void GapcoinGUI::createActions(bool fIsTestnet)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Gapcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and gapcoin: URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Gapcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Gapcoin addresses"));
...
void GapcoinGUI::createTrayIcon(bool fIsTestnet)
{
    ...
    if (!fIsTestnet)
    {
        trayIcon->setToolTip(tr("Gapcoin client"));
        trayIcon->setIcon(QIcon(":/icons/toolbar"));
    }
    else
    {
        trayIcon->setToolTip(tr("Gapcoin client") + " " + tr("[testnet]"));
