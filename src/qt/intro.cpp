...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/gapcoin"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Gapcoin"),
     ...
     * override -datadir in the gapcoin.conf file in the default data directory
     * (to be consistent with gapcoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
