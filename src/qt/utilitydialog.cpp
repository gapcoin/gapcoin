    ...
    ui(new Ui::AboutDialog)
{
    ...
    ui->copyrightLabel->setText(tr("Copyright") + QString(" &copy; 2009-%1 ").arg(COPYRIGHT_YEAR) + tr("The Gapcoin Core developers"));
}
    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    header = tr("Gapcoin Core") + " " + tr("version") + " " +
...
void ShutdownWindow::showShutdownWindow(GapcoinGUI *window)
{
    ...
    layout->addWidget(new QLabel(
        tr("Gapcoin Core is shutting down...") + "<br /><br />" +
