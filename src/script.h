...
#ifndef H_GAPCOIN_SCRIPT
#define H_GAPCOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CGapcoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, Gapcoin always counted CHECKMULTISIGs
