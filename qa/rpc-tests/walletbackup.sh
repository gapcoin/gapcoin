...
function StartThree {
  $GAPCOIND $GAPCOINDARGS $B1ARGS &
  B1PID=$!
  $GAPCOIND $GAPCOINDARGS $B2ARGS &
  B2PID=$!
  $GAPCOIND $GAPCOINDARGS $B3ARGS &
  B3PID=$!
}
